    ...
    execute: function () {
      ...
      _export("Game_Board", Game_Board = (_dec = ccclass('Game_Board'), _dec2 = property(Node), _dec3 = property(Prefab), _dec(_class = (_class2 = (_class3 = class Game_Board extends Component {
        ...
        show_grids(grid_size) {
          ...
          var pos_x = Game_Board.origin_pos.x + Game_Board.half_region_size - Game_Board.half_square_size;

          for (var row = 0; row < rows; row++) {
            var pos_z = Game_Board.origin_pos.z + Game_Board.half_region_size - Game_Board.half_square_size;
...
//# sourceMappingURL=fb833b308949310e7e247341e65466be65e26909.js.map