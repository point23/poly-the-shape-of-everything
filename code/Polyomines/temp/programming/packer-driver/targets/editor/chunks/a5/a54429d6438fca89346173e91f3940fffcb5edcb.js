    ...
    execute: function () {
      ...
      _export("Swipe_Camera", Swipe_Camera = (_dec = ccclass('Swipe_Camera'), _dec2 = property(Camera), _dec(_class = (_class2 = class Swipe_Camera extends Component {
        ...
        on_keyboard_down(event) {
          ...
          if (key_code == KeyCode.ARROW_LEFT) {
            this.camera.node.position.add(new Vec3(0, 0, -1));
          } else if (key_code == KeyCode.ARROW_RIGHT) {
            this.camera.node.position.add(new Vec3(0, 0, -1));
          } else if (key_code == KeyCode.ARROW_UP) {
            this.camera.node.position.add(new Vec3(0, 0, -1));
          } else if (key_code == KeyCode.ARROW_DOWN) {
            this.camera.node.position.add(new Vec3(0, 0, -1));
          }
        }
...
//# sourceMappingURL=a54429d6438fca89346173e91f3940fffcb5edcb.js.map