System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Camera, Component, input, Input, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Swipe_Camera;
    ...
    execute: function () {
      ...
      _export("Swipe_Camera", Swipe_Camera = (_dec = ccclass('Swipe_Camera'), _dec2 = property(Camera), _dec(_class = (_class2 = class Swipe_Camera extends Component {
        ...
        register_event() {
          ...
          input.on(Input.EventType.KEY_PRESSING, this.on_key_pressing, this);
        }

        unregister_event() {
          input.off(Input.EventType.KEY_DOWN, this.on_key_down, this);
          input.off(Input.EventType.KEY_UP, this.on_key_up, this);
          input.off(Input.EventType.KEY_PRESSING, this.on_key_pressing, this);
        }

        on_key_down(event) {
          let key_code = event.keyCode;
          console.log(`key down: ${key_code}`); // if (key_code == KeyCode.KEY_W) {
...
//# sourceMappingURL=d7cf8cb67c77f899513681443bae76a74135ae71.js.map